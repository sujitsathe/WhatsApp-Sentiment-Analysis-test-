...
# Will return count of messages of selected user per day 
...
# Will return count of messages of selected user per month 
...
# Will return hear map containing count of messages
...
# Will return count of messages of selected user per date 
...
# Will return count of messages of selected user per (year + month number + month)
...
# Will return percentage of message contributed 
def percentage(df,k):
